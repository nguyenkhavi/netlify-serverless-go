...
export const Icons = {
  ...
  InstagramIcon: { icon: InstagramIcon },
  MobilePhoneIcon: { icon: MobilePhoneIcon },
  ...
  QuestionCircleIcon: { icon: QuestionCircleIcon },
  ListViewIcon: { icon: ListViewIcon },
  LoadingIcon: { icon: LoadingIcon },
  CrossIcon: { icon: CrossIcon },
